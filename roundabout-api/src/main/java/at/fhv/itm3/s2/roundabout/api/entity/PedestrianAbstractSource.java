...
public abstract class PedestrianAbstractSource extends AbstractProducer {
    private String id;
    private double generatorExpectation;

    public PedestrianAbstractSource(Double generatorExpectation, Model model, String description, boolean showInTrace) {
        this(UUID.randomUUID().toString(), generatorExpectation, model, description, showInTrace);
    }

    public PedestrianAbstractSource(String id, Double generatorExpectation, Model model, String description, boolean showInTrace) {
     ...
     */
    public abstract void startGeneratingPedestrians(double afterModelTimeUnits);
